...
public class Attendence {
    ...
    void Display(ActionEvent event) {
        ...
        String connectQuery = "SELECT ClassName FROM Classes;";
        ...
        try {
            ...
            while (queryOutput.next()) {
                String className = queryOutput.getString("ClassName");
    ...
    private void saveAttendanceToDatabase(String studentName, String status) {
        ...
        String checkQuery = "SELECT * FROM AttendanceRecords WHERE StudentName = ? AND DATE(Timestamp) = ?";
        String insertQuery = "INSERT INTO AttendanceRecords (StudentName, Status, Timestamp) VALUES (?, ?, ?)";
